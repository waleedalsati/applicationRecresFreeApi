...
class _Services implements Services {
  ...
  @override
  Future<responseUsers> getallusers(String apikey) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'x-api-key': apikey};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<responseUsers>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'users',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late responseUsers _value;
    try {
      _value = responseUsers.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
